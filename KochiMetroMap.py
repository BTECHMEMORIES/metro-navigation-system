...
public class KochiMetroMap extends MetroMap {
    ...
    public KochiMetroMap() {
        ...
        CreatePath("Terminal_Aluva", "Aluva", "blue", 0);
        ...
        CreatePath("Kakkanad", "Infopark", "blue", 1);
        CreatePath("Infopark", "Technocity", "blue", 1);
        CreatePath("Technocity", "Kinfra", "blue", 1);
        CreatePath("Kinfra", "Cusat", "blue", 2);
        CreatePath("Cusat", "Terminal_Cusat", "blue", 0);

        // Purple Line
        CreatePath("Terminal_Jawaharlal Nehru Stadium", "Jawaharlal Nehru Stadium", "purple", 0);
        ...
        CreatePath("Kundannoor", "Petta", "purple", 2); // Unified spelling
        CreatePath("Petta", "Kacheripady", "purple", 1);
        CreatePath("Kacheripady", "Changampuzha Park", "purple", 2);
        CreatePath("Changampuzha Park", "Palarivattom", "purple", 3);
        CreatePath("Palarivattom", "Terminal_Palarivattom", "purple", 0);
